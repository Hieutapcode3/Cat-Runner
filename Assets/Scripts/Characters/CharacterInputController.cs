...
public class CharacterInputController : MonoBehaviour
{
	...
	protected void Update ()
    {
        ...
        // Use key input in editor, standalone, or WebGL (for desktop browsers)
        ...
        // Use touch input on mobile and WebGL (for mobile browsers)
...
#else
        // Use touch input on mobile (non-WebGL)
        if (Input.touchCount == 1)
        {
			if(m_IsSwiping)
			{
